/// <summary>
/// TableExtension NCT Etax Billing Receipt Head. (ID 80202) extends Record NCT Billing Receipt Header.
/// </summary>
tableextension 80202 "NCT Etax Billing Receipt Head." extends "NCT Billing Receipt Header"
{
    fields
    {
